    ...
    <b-row class="main-content">
      ...
      <b-form>
        ...
        <b-input-group prepend="USD" class="mb-2 mr-sm-2 mb-sm-0">
          ...
          <b-form-input v-model.number="dollarValue" placeholder="Enter a positive $ value" @change="chageDollarValue(dollarValue)"></b-form-input>
        </b-input-group>
        <h4>in</h4>
        <b-form-row>
          <b-col>
            <b-form-select class="mb-2 mr-sm-2 mb-sm-0" v-model="selectedCrypto" :options="cryptoOptions" @change="changeCrypto(selectedCrypto)"></b-form-select>
          </b-col>
          <b-col>
      ...
      <br /><br />
      <h4>It would be worth <h2 class="net-worth">${{this.profitloss}}</h2> today</h4>
    </b-row>
    <b-row>
      <h4 class="ads">
...
export default {
  ...
  computed: {
    profitloss: function() {
      return this.dollarValue + (this.dollarValue * (this.incidents * 100))/100
    } 
  },
  methods: {
    async getIncidents() {
